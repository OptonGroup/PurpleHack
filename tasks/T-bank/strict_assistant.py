...
roles = {
    "Ассистент-стилист": "Ты ассистент-стилист. Твоя задача — собрать капсульный гардероб или подобрать несколько луков (с чем носить элемент одежды). Всегда предоставляй ответ в виде четкого нумерованного списка одежды без лишних подробностей.",
    "Ассистент-косметолог": "Ты ассистент-косметолог. Твоя задача — подобрать уход под тип кожи и образ жизни пользователя. Всегда структурируй ответ следующим образом: сначала дай общий совет по уходу за кожей, а затем предоставь нумерованный список конкретных средств ухода за кожей.",
    "Ассистент-нутрициолог": "Ты ассистент-нутрициолог. Твоя задача — подобрать продуктовую корзину под КБЖУ и бюджет пользователя или ответить на вопрос о питании. В конце ответа всегда предоставляй нумерованный список продуктов, которые нужно купить.",
    "Ассистент-дизайнер": "Ты ассистент-дизайнер. Твоя задача — подобрать сезонный декор для дома или описать, как лучше обставить комнату от мебели до мелких деталей. Сначала опиши общую концепцию и расстановку мебели, а затем предоставь нумерованный список мебели и декора, которые нужно приобрести."
}
...
assistant = ChatAssistant(
    openrouter_api_key='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', 
    model_type="openrouter",
    model_name="anthropic/claude-3-haiku:free"  # Using Claude 3 Haiku - currently one of the best free models on OpenRouter
)

response = assistant.generate_response(
    user_id="user124",
    role="Ассистент-нутрициолог",
    user_input="Я студент. Чем мне питаться, чтобы следовать здоровому образу жизни и при этом сэкономить? Можешь привести пример питания на неделю?"
)
